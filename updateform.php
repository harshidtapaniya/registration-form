...
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  $query = "Select * from `stool` where id='$id'";
...
?>
    ...
    <body>
      ...
      <div class="container">
        <div class="header">
          <h1 style="position: relative; left: 270px; color:white;">Update Form</h1>
        </div>
        <div class="image">
          ...
          <div class="row g-2">
            <div class="col-md">
              <div class="form-floating" id="name">
                <input type="text" onkeyup="fnamevalidation()" class="form-control" name="fname" id="fname" placeholder="" value="<?php echo $data['firstname']; ?>">
            ...
            <div class="col-md">
              <div class="form-floating">
                <input type="text" onkeyup="lnamevalidation()" class="form-control" name="lname" id="lname" placeholder="" value="<?php echo $data['lastname']; ?>"><span class="formerror"></span>
            ...
            <div class="row g-2">
              <div class="col-md">
                <div class="form-floating">
                  <input type="email" onkeyup="emailvalidation()" class="form-control" name="email" id="email" placeholder="" value="<?php echo $data['email']; ?>"><span class="formerror"></span>
              ...
              <div class="col-md">
                <div class="form-floating">
                  <input type="text" onkeyup="usernamevalidation()" class="form-control" name="username" id="username" value="<?php echo $data['username']; ?>" placeholder=""><span class="formerror"></span>
              ...
              <div class="row g-2">
                <div class="col-md">
                  <div class="form-floating">
                    <input type="text" onkeyup="passwordvalidation()" name="pass" class="form-control" id="password" value="<?php echo $data['ppassword']; ?>" placeholder="Enter your password" aria-label="Password" aria-describedby="password-toggle">
                ...
                <div class="col-md">
                  <div class="form-floating">
                    <input type="text" onkeyup="cpasswordvalidation()" name="confirm" class="form-control" id="password1" value="<?php echo $data['confirmpassword']; ?>" placeholder="confirm your password" aria-label="Password" aria-describedby="password2-toggle">
                ...
                <div class="row g-2">
                  <div class="col-md">
                    ...
                    <?php  $city = $data['city'];
                      ...
                      <select onchange="cityvalidation()" name="city" id="city" value="<?php echo $data['city']; ?>" class="form-select">
                        <!-- <option selected disabled value="">City</option> -->
                        <option  <?php if($city == 'surat'){ echo "selected";} ?>>Surat </option>
                        <option <?php if($city == 'mumbai'){ echo "selected";} ?>>Mumbai</option>
                        <option <?php if($city == 'ahemdabad'){ echo "selected";} ?>>Ahemdabad</option>
                        <option <?php if($city == 'navsari'){ echo "selected";} ?> >Navsari</option>
                        <option <?php if($city == 'amreli'){ echo "selected";} ?>>Amreli</option>
                        <option <?php if($city == 'gandhinagar'){ echo "selected";} ?>>Gandhinagar</option>
                        <option <?php if($city == 'jamnagar'){ echo "selected";} ?>>Jamnagar</option>
                      </select>
                    </div>
                  ...
                  <div class="col-md">
                    <div class="form-floating">
                      ...
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions" value="male" id="inlineRadio1" <?php if($gender == 'male'){ echo "checked";} ?> >
                        <label class="form-check-label" for="inlineRadio1" style="color: white;">Male</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions" value="female" id="inlineRadio2" <?php if($gender == 'female'){ echo "checked";} ?> >
                        <label class="form-check-label" for="inlineRadio2" style="color: white;">Female</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions" value="other" id="inlineRadio3"  <?php if($gender == 'other'){ echo "checked";} ?> >
                ...
                <div class="row g-2">
                  <div class="col-md">
                    <div class="form-floating">
                      <input type="dated" onkeyup="DOBvalidation()" class="form-control" name="dob" id="DOB" value="<?php echo $data['birthdate']; ?>" placeholder="" >
                  ...
                  <div class="col-md">
                    <div class="form-floating">
                      ...
                      <input type="number" onkeyup="agevalidation()" class="form-control" name="age" id="age" value="<?php echo $data['age']; ?>" placeholder="">
                ...
                <div class="row g-1">
                  <div class="col-md">
                    <div class="form-floating">
                      <!-- <img src="closeeye.jpeg"> -->
                      <input type="number" onkeyup="numbervalidation()" class="form-control" name="phonenum" value="<?php echo $data['mobilenumber']; ?>" id="tnumber" maxlength="10" ;>
                ...
                <div class="button">
                  <div class="d-grid gap-2">
                    <button class="btn btn-primary" type="button" onclick="submitdata()" name="Update">Update</button>
      ...
      <script>
        ...
        function usernamevalidation() {
          ...
          if (username == "") {
            ...
            document.getElementById("username-error").innerHTML = "**username minimum 3 character**";
            return false;
          } else {
